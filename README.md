...
一个基于 Astro 和 GitHub Pages 的个人博客。当前版本采用高级沉浸式私人档案终端风格：深石墨背景、暖白文字、低饱和琥珀光、冷蓝系统光、细线网格、原创数据舱和原生 Canvas 沉浸动效。内容包含生活档案、技术记录、个人简介、灵感实验室和网页发布后台。
...
- `/`：首页，包含沉浸式 Hero、任务索引、精选档案、生活/技术分栏、个人档案和灵感实验室预览。
